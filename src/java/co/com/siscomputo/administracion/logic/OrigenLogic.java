...
public class OrigenLogic {
     ...
     * @return
     */
    public OrigenEntity actualizarOrigen(OrigenEntity obj) {
        try {
            String conexion = initOperation();
            if ("OK".equalsIgnoreCase(conexion)) {
                sesion.update(obj);
    ...
    public ObjetoRetornaEntity listarOrigen() {
        ...
        try {
            String conexion = initOperation();
            if ("OK".equalsIgnoreCase(conexion)) {
                Query sentencia = sesion.createQuery("From OrigenEntity");
